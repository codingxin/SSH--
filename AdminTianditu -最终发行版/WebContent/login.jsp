    ...
    <div class="text-center">
        <p>
            <small class="text-muted">
                <a href="" target="_blank"> 主办单位:</a> 湖南省国土资源厅 &copy; 2018&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <br>
            </small>
            <small class="text-muted">
                <a href="" target="_blank">技术支持:</a> 湖南省第三测绘院 湖南省国土资源信息中心&nbsp;&nbsp;	 <br>
            </small>
            <small class="text-muted">
                <a href="" target="_blank">&nbsp;审图号:</a> 湘S（2015）45号 备案号: 湘ICP备 11014573-2号 
            </small>
       </p>
    </div>
</div>
