	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="box box-info">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<!--  action="/AdminTianditu/hengyang/insert" -->
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="update_title"
									name="title" maxlength="10" placeholder="请输入更新日志标题" required>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control" rows="3" id="update_extra"
									name="extra" placeholder="请输入更新日志内容"></textarea>
							</div>
						</div>
						<div class="form-group">
		...
		$(function() {
			...
			$member_add_form
					.submit(function() {
						...
						//alert($("#member_add_form").serialize()); 序列化 表格数据
						$
								.ajax({
									url : "/AdminTianditu/yongzhou/insert",
									type : "POST",
									dataType : "json",
									data : md,
									...
									success : function(data) {
										alert(data.msg);
										//更新成功后返回列表
										window.location.href = "/AdminTianditu/yongzhou/showList";
										if (data.success) {
