...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i>
				...
				<ul class="treeview-menu">
					...
					<li><a href="/AdminTianditu/admin/showChangde"
						target="container"><i class="fa fa-circle-o"></i> 常德日志 </a></li>
				</ul></li>
			...
			<li class="treeview"><a href="#"> <i class="fa fa-users"></i>
				...
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/changde/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/changde/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>长沙日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/changsha/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/changsha/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>
			...
			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
				...
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/yueyang/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/yueyang/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>怀化日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/huaihua/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/huaihua/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>衡阳日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/hengyang/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/hengyang/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>株洲日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/zhuzhou/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/zhuzhou/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>永州日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/yongzhou/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/yongzhou/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>郴州日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/chenzhou/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/chenzhou/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>张家界日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/zhangjiajie/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/zhangjiajie/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>邵阳日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/shaoyang/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/shaoyang/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>益阳日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/yiyang/showAdd" target="container"><i
							class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/yiyang/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>娄底日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/loudi/showAdd" target="container"><i
							class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/loudi/showList" target="container"><i
							class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>
			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>吉首日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/jishou/showAdd" target="container"><i
							class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/jishou/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>

			<li class="treeview"><a href="#"> <i class="fa fa-edit"></i>
					<span>湘潭日志</span> <span class="pull-right-container"> <i
						class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li><a href="/AdminTianditu/xiangtan/showAdd"
						target="container"><i class="fa fa-circle-o"></i> 添加日志 </a></li>
					<li><a href="/AdminTianditu/xiangtan/showList"
						target="container"><i class="fa fa-circle-o"></i> 日志列表 </a></li>
				</ul></li>
		...
		</strong> All Rights Reserved &copy; 2018 </footer>
	</div>
	<!-- ./wrapper -->
