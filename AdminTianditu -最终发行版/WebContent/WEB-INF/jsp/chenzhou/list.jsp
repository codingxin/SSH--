			...
			<div class="box">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover table-bordered text-center">
						...
						<c:if test="${ChenzhouList!=null }">
							<%--  varStatus是<c:forEach>jstl循环标签的一个属性，varStatus属性。 例如实现隔行变色标志--%>
							<c:forEach var="member" items="${ChenzhouList }"
								varStatus="status">
								<tr>
					...
					<form class="form-horizontal" method="post" id="member_update_form">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="update_place" type="hidden"
									class="col-sm-2 control-label" name="update_place">更新地点</label>
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-6">
		...
		$(function() {
					...
					.click(
							function() {
								if (confirm("确认要删除吗？")) {
									...
									$
											.ajax({
												url : "/AdminTianditu/chenzhou/del",
												type : "POST",
												data : {
													id : id
												},
												...
												success : function(data) {
													...
													if (data.success) {
														//菜单栏当前选中
														window.location.href = "/AdminTianditu/chenzhou/showList";
			...
			$member_update_form
					.submit(function() {
						...
						$
								.ajax({
									url : "/AdminTianditu/chenzhou/update",
									type : "POST",
									dataType : "json",
									data : md,
									beforeSend : function() {
