...
//			s_admin=(Admin) session.getAttribute("s_admin");
	...
	@RequestMapping(value="/showChangde")
	public ModelAndView showChangde(){
		return new ModelAndView("../../showChangde");
	}
	@RequestMapping(value="/showChangsha")
	public ModelAndView showChangsha(){
		return new ModelAndView("../../showChangsha");
	}
