        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-bordered text-center">
            ...
            <tr>
              ...
              <td>
                <a data-id="${member.id }" class="update" href="javascript:void(0)" data-toggle="modal" data-remote="false" data-target="#member_update_modal" data-backdrop="static">
                  <i class="fa fa-edit"></i>编辑</a> |
                <a data-id="${member.id }" class="del" href="javascript:void(0)">
...
<!-- Modal -->
<div class="modal fade" id="member_update_modal" tabindex="-1" role="dialog" aria-labelledby="member_update_label">
        ...
        <form class="form-horizontal" method="post" id="member_update_form">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea class="form-control" rows="3" id="update_extra" name="extra" placeholder="请输入更新内容，100字以内，选填"></textarea>
              </div>
            </div>
          </div>
          <!-- /.box-body -->
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-info pull-right" id="member_update_button" data-loading-text="更新中...">更新</button>
          </div>
          <!-- /.box-footer -->
        </form>
      </div>
...
<script>
    $(function(){
        ...
        $(".update").click(function () {
            ...
            $("#update_title").val($(this).parent().prevAll(".update_title").text());
            $("#update_extra").val($(this).parent().prevAll(".update_extra").text());
        });
