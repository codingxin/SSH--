				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-hover table-bordered text-center">
						...
						<c:if test="${ChangdeList!=null }">
							...
							<c:forEach var="member" items="${ChangdeList }"
								varStatus="status">
								<tr>
		...
		$(function() {
			...
			$(".del")
					.click(
							function() {
								...
								if (confirm("确认要删除吗？")) {
									var id = $(this).data("id");
									$.ajax({url : "/AdminChangde/changde/del",
												type : "POST",
												data : {
													id : id
												},
												...
												success : function(data) {
													...
													if (data.success) {
														//菜单栏当前选中
														window.location.href = "/AdminChangde/changde/showList";
			...
			$member_update_form
					.submit(function() {
						...
						alert(md);
						$.ajax({     url : "/AdminChangde/changde/update",
									type : "POST",
									dataType : "json",
									data : md,
									beforeSend : function() {
